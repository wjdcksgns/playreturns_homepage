...
class Train():
    ...
    def parse_opt(self, known=False):
        ...
        parser.add_argument('--project', default=Path("D:/labeling_server/dataUtil/model_weight_result") / 'train', help='save to project/name')
    ...
    def main(self, opt, callbacks=Callbacks()):
        ...
        if opt.resume and not check_comet_resume(opt) and not opt.evolve:
            ...
            # opt.save_dir = str(increment_path(Path('D:/labeling_server') / opt.name, exist_ok=opt.exist_ok))
