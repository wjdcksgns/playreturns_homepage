...
const techList = [
  ...
  },
  {
    ...
    description:
      'LLM과 AI 에이전트를 활용해 복잡한 문제 해결과 자동화된 의사결정을 지원합니다. 서술형 데이터를 정량화한 AI 매칭·평가 자동화 시스템(서울대학교 멘토-멘티 매칭·경진대회 심사 등)을 구축한 경험이 있습니다.',
    fields: ['AI 매칭 자동화', '평가·심사 시스템', '업무 자동화', '지능형 데이터 분석'],
    icon: <FaBrain />,
    accent: '#8b5cf6',
  },
  {
